...
<div class="row justify-content-center">
    <div class="col-4">
        ...
        @if (isset($error) && $error == "can_register_false")
            <div class="alert alert-danger" role="alert">Registration is currently disabled. Please try again later. Please <a href="/contact">contact us</a> if you need assistance.</div>
        @else
