...
<div class="tab-content" id="settingsTabsContent">
	<div class="tab-pane fade show active" id="general-tab-pane" role="tabpanel" aria-labelledby="general-tab" tabindex="0">
		...
		<div class="mb-3 form-check">
			<input type="checkbox" class="form-check-input" id="can_register" name="can_register">
			<label class="form-check-label" for="can_register">Allow Registration</label>
		</div>
		<div class="mb-3 form-check">
			<input type="checkbox" class="form-check-input" id="can_signature" name="can_signature">
		...
		<div class="mb-3">
			...
			<input type="text" class="form-control" id="maintenance_message" aria-describedby="maintenance_message_help" name="maintenance_message">
		...
		<p><select class="form-select" name="contact_type" style="max-width:300px;">
			<option value="default" selected>Default Contact Page</option>
			<option value="custom">Custom Contact Link</option>
		</select></p>
		<div class="mb-3">
			<label for="contact_link" class="form-label">Custom Contact Link</label>
			<input type="text" class="form-control" id="contact_link" aria-describedby="contact_link_help" name="contact_link">
	...
	<div class="tab-pane fade" id="pages-tab-pane" role="tabpanel" aria-labelledby="pages-tab" tabindex="0">
		...
		<p><textarea class="form-control" rows="10" name="terms_content"></textarea></p>
		<p><strong>Privacy Policy</strong></p>
		<p><textarea class="form-control" rows="10" name="privacy_content"></textarea></p>
	</div>
	<div class="tab-pane fade" id="integration-tab-pane" role="tabpanel" aria-labelledby="integration-tab" tabindex="0">
		...
		<p><select class="form-select" style="max-width:300px;">
